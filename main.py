...
def main():
    ...
    with st.sidebar.expander("ℹ️ About this project"):
        st.markdown(
            """
            **ReviewSense AI** blends **Collaborative Filtering (SVD)**
            with **Content-Based NLP (TF-IDF)** to recommend products
            from real customer reviews — with built-in sentiment
            analysis and a live analytics dashboard.
            """
        )
