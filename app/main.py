...
def auth():
    st.title(" Login / Signup to AI Food Recommendation System")
    st.markdown("---")
...
def main():
    ...
    with st.sidebar.expander(" About this project"):
        st.markdown(
            """
            **AI Food Recommendation System** blends **Collaborative
            Filtering (SVD)** with **Content-Based NLP (TF-IDF)** to
            recommend food products from real Amazon customer reviews —
            with built-in sentiment analysis and a live analytics
            dashboard.
            """
        )
    ...
    st.sidebar.markdown(
        """
        <div style="font-size:0.85rem; opacity:0.85; line-height:1.7;">
            Developed by <b>Aditi Tiwari</b><br>
            <a href="https://github.com/tiwariataditi-collab/ReviewSense-AI" target="_blank">GitHub</a>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown("Discover the best food products driven by **TF-IDF Cosine Similarity** and **Sentiment Analysis**.")
